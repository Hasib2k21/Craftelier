...
class _CraftyBayState extends State<CraftyBay> {
  late final StreamSubscription<List<ConnectivityResult>> _connectivityResultSubscription;
  ...
  void checkInternetConnectivityStatus() {
    _connectivityResultSubscription = Connectivity().onConnectivityChanged.listen((List<ConnectivityResult> connectionResults) {
